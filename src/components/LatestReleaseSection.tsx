...
const LatestReleaseSection = () => {
  ...
  return (
    <section id="music" className="relative py-24 md:py-32 bg-cosmos overflow-hidden">
      {/* Decorative line */}
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-6xl text-center">
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 px-10 py-4 border border-gold text-gold font-heading text-sm tracking-cinematic hover:bg-gold hover:text-primary-foreground transition-all duration-500 hover:shadow-[0_0_30px_hsl(40_60%_50%/0.3)]"
          >
